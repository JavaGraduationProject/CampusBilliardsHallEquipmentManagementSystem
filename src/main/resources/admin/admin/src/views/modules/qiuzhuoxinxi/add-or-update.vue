<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="普通时价" prop="putongshijia">
          <el-input v-model="ruleForm.putongshijia" 
              placeholder="普通时价" clearable  :readonly="ro.putongshijia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="普通时价" prop="putongshijia">
              <el-input v-model="ruleForm.putongshijia" 
                placeholder="普通时价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="球桌状态" prop="qiuzhuozhuangtai">
          <el-select :disabled="ro.qiuzhuozhuangtai" v-model="ruleForm.qiuzhuozhuangtai" placeholder="请选择球桌状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="球桌状态" prop="qiuzhuozhuangtai">
	      <el-input v-model="ruleForm.qiuzhuozhuangtai"
                placeholder="球桌状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="球桌详情" prop="qiuzhuoxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.qiuzhuoxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qiuzhuoxiangqing" label="球桌详情" prop="qiuzhuoxiangqing">
                    <span v-html="ruleForm.qiuzhuoxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	huiyuanshijia : false,
	putongshijia : false,
	qiuzhuozhuangtai : false,
	qiuzhuoxiangqing : false,
      },
      ruleForm: {
        zhuohao: '',
        tupian: '',
        huiyuanshijia: '',
        putongshijia: '',
       qiuzhuozhuangtai: '可预约',
        qiuzhuoxiangqing: '',
      },
          qiuzhuozhuangtaiOptions: [],
      rules: {
          zhuohao: [
          ],
          tupian: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.huiyuanshijia = true;
          ...
          if(o=='putongshijia'){
            this.ruleForm.putongshijia = obj[o];
	    this.ro.putongshijia = true;
            continue;
          }
          if(o=='qiuzhuozhuangtai'){
            this.ruleForm.qiuzhuozhuangtai = obj[o];
	    this.ro.qiuzhuozhuangtai = true;
            continue;
          }
          if(o=='qiuzhuoxiangqing'){
            this.ruleForm.qiuzhuoxiangqing = obj[o];
	    this.ro.qiuzhuoxiangqing = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.qiuzhuoxiangqing = this.ruleForm.qiuzhuoxiangqing.replace(reg,'../../../springboott50fc/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `qiuzhuoxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.qiuzhuoxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
