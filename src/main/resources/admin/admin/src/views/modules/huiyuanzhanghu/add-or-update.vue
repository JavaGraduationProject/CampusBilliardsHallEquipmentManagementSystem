<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="开卡时间" prop="kaikashijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.kaikashijian" 
                type="datetime"
                :readonly="ro.kaikashijian"
                placeholder="开卡时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaikashijian" label="开卡时间" prop="kaikashijian">
              <el-input v-model="ruleForm.kaikashijian" 
                placeholder="开卡时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.kaikashijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jine = true;
          ...
          if(o=='kaikashijian'){
            this.ruleForm.kaikashijian = obj[o];
	    this.ro.kaikashijian = true;
            continue;
          }
          if(o=='yonghuzhanghao'){
